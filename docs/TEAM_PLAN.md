...
Источник требований: [ТЗ HackAlem AI](https://docs.google.com/document/d/1JPLU-G6R25Ge2hVaY2J9cqvrx7FGExj87XKwJPaMz3o/edit?tab=t.2mrm4atu16r8). Схемы файлов уточняются по README предоставленного датасета. Python CLI и NestJS объединены и проверены на реальном наборе локально и в Docker; UI-интеграция остаётся задачей команды. Ниже сохранён план ответственности и приёмки, а не отметка о выполнении всех пунктов. Актуальное состояние и команды — в корневом README.
